...
<div class='suppliers'>
  ...
  <el-row class="add-supplier-form">
    <el-col :span="7">
      <el-input v-model="newSupplierName" placeholder="输入新的供应商的名称"></el-input>
    </el-col>
    <el-col :span="1"></el-col>
    <el-col :span="9">
      <el-input v-model="newSupplierAddres" placeholder="输入新的供应商的地址"></el-input>
    </el-col>
    <el-col :span="1"></el-col>
    <el-col :span="6">
        <el-button type="success" plain @click="handleAddSupplier" class="add-supplier-btn">添加供应商</el-button>
      </el-col>
  </el-row>
  <!-- 供应商数据 -->
  <el-table
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <el-button type="danger" @click="handleDeleteSupplier(scope.$index, scope.row)" class="delete-btn">删除</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 修改功能 -->
